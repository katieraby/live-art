    ...
    <div className={styles.homepage}>
      ...
      <div className={styles.blobContainer}>
        ...
        >
          <path
            fill="#E86252"
            d="M51.7,-72.6C65.5,-61.2,73.9,-44,76.1,-27.1C78.3,-10.2,74.3,6.3,67.5,20.3C60.6,34.2,51,45.5,39.3,58.2C27.6,70.8,13.8,84.7,-2.2,87.7C-18.2,90.8,-36.4,82.9,-49.3,70.7C-62.3,58.5,-70,41.9,-72.4,25.6C-74.8,9.4,-71.8,-6.5,-65.1,-19.3C-58.3,-32,-47.8,-41.7,-36.4,-53.8C-24.9,-66,-12.5,-80.5,3.3,-85C19,-89.6,38,-84,51.7,-72.6Z"
            transform="translate(100 100)"
          />
        </svg>
